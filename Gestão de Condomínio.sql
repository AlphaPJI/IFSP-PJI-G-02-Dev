...
insert into Comentario values (1, 29, 1, 'Nova area de piscinas','Piscina', 'Senti muita falta de uma pscina nesse calor, será se tem como por uma no condominio?', false, '2022-10-21 12:00:07');
...
SELECT * FROM Comentario WHERE id_categoria = 1 ORDER BY data_publicacao DESC;
